<p align="center">
  <img src="https://cdn.jsdelivr.net/gh/hishprorg/corporis-nulla-eos/client/images/readme-logo.svg"/>
</p>
<p align="center">
  <a href="https://www.npmjs.org/package/@droppyjs/cli"><img src="https://img.shields.io/npm/v/@droppyjs/cli.svg"></a>
  <a href="https://raw.githubusercontent.com/hishprorg/corporis-nulla-eos/master/LICENSE"><img src="https://img.shields.io/badge/licence-bsd-blue.svg"></a>
</p>
...
<p align="center">
   <a href="https://raw.githubusercontent.com/hishprorg/corporis-nulla-eos/canary/media/1-Listing.png"><img src="https://raw.githubusercontent.com/hishprorg/corporis-nulla-eos/canary/media/1-Listing.png" width="300"></a> <a href="https://raw.githubusercontent.com/hishprorg/corporis-nulla-eos/canary/media/2-Actions.png"><img src="https://raw.githubusercontent.com/hishprorg/corporis-nulla-eos/canary/media/2-Actions.png" width="300"></a> <a href="https://raw.githubusercontent.com/hishprorg/corporis-nulla-eos/canary/media/3-Split.png"><img src="https://raw.githubusercontent.com/hishprorg/corporis-nulla-eos/canary/media/3-Split.png" width="300"></a>
</p>
...
We currently publish our images to `ghcr.io/hishprorg/corporis-nulla-eos`. You can bind columnes /data and /config should you need. 

### docker-compose

A sample docker-composer file can be found here: https://github.com/hishprorg/corporis-nulla-eos/blob/canary/examples/docker-compose.yml
...
````sh
$ git clone https://github.com/hishprorg/corporis-nulla-eos && cd droppy
$ lerna bootstrap
$ yarn start
````
The [Makefile](https://github.com/hishprorg/corporis-nulla-eos/blob/master/Makefile) has a few old tasks for updating dependencies, pushing docker images, see the comment above for dependencies of those tasks. This should not be required anymore, but is left as a reference.
